            ...
            <Grid.Column width={12}>
              <Table fixed basic="very">
                <Table.Body>
                  ...
                  {this.handleDOD(member.DODYear, member.DODMonth, member.DODDay)}
                  <Table.Row>
                    <Table.HeaderCell>Date of Birth</Table.HeaderCell>
                    {/* <Table.Cell>Not available</Table.Cell> */}
                    <Table.Cell>{this.handleDOB(member.DOBYear,member.DOBMonth,member.DOBDay)}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.HeaderCell>Gender</Table.HeaderCell>
                    <Table.Cell>{this.handleGender(member.Gender)}</Table.Cell>
                  </Table.Row>
                </Table.Body>
              </Table>
            </Grid.Column>
